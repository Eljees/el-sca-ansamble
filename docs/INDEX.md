...
6. `audit/270-analysis-2026-06-11.md` — **latest**: full analysis pass (2026-06-11): D-NEW-1 gitkeep deletions, D-NEW-2 runtime proxy config, phased plan.
7. `audit/260-fixups-2026-06-11.md` — fix pass: README cleanup, proxy-chain tests, gitignore, nvd-feeds untrack.
8. `audit/250-fixups-2026-06-09.md` — proxy healthcheck + CVE source isolation.
9. `audit/240-analysis-2026-06-08.md` — full analysis pass (2026-06-08).
10. `audit/archive/` — superseded planning notes (`PLAN_2026-05-1x.md`).
11. `../CHANGELOG.md` — release notes (Keep a Changelog).
