...
### 2f. Оставшиеся заглушки в документации

| Файл | Размер | Состояние |
|---|---|---|
| `docs/security-notes.md` | 9 строк | Заглушка |
| `docs/windows-powershell.md` | 17 строк | Заглушка |
| `docs/custom-sources.md` | 24 строки | Не обновлён для proxy auth |
